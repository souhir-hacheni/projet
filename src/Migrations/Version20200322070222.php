 ...
 */
final class Version20200322070222 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adhesion CHANGE adherant_id adherant_id INT DEFAULT NULL, CHANGE montant montant VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE date_adhesion date_adhesion DATE DEFAULT \'NULL\', CHANGE annee_adhesion annee_adhesion VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE paiement paiement TINYINT(1) DEFAULT \'NULL\'');
