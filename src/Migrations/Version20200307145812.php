 ...
 */
final class Version20200307145812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherant DROP yes');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherant ADD yes VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
