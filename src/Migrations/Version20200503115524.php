 ...
 */
final class Version20200503115524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherant ADD adherant_id INT DEFAULT NULL, CHANGE adresse adresse VARCHAR(255) DEFAULT NULL, CHANGE tel tel INT DEFAULT NULL, CHANGE mail mail VARCHAR(255) DEFAULT NULL, CHANGE cin cin INT DEFAULT NULL');
        $this->addSql('ALTER TABLE adherant ADD CONSTRAINT FK_97DA58BCBE612E45 FOREIGN KEY (adherant_id) REFERENCES bureau_directeur (id)');
        $this->addSql('CREATE INDEX IDX_97DA58BCBE612E45 ON adherant (adherant_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherant DROP FOREIGN KEY FK_97DA58BCBE612E45');
        $this->addSql('DROP INDEX IDX_97DA58BCBE612E45 ON adherant');
        $this->addSql('ALTER TABLE adherant DROP adherant_id, CHANGE adresse adresse VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE tel tel INT DEFAULT NULL, CHANGE mail mail VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE cin cin INT DEFAULT NULL');
