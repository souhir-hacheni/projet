 ...
 */
final class Version20200503120429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE revenu ADD evenement_id INT DEFAULT NULL, CHANGE designation designation VARCHAR(255) DEFAULT NULL, CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT NULL, CHANGE quantite quantite DOUBLE PRECISION DEFAULT NULL, CHANGE total total INT DEFAULT NULL, CHANGE date_action date_action DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE revenu ADD CONSTRAINT FK_7DA3C045FD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id)');
        $this->addSql('CREATE INDEX IDX_7DA3C045FD02F13 ON revenu (evenement_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE revenu DROP FOREIGN KEY FK_7DA3C045FD02F13');
        $this->addSql('DROP INDEX IDX_7DA3C045FD02F13 ON revenu');
        $this->addSql('ALTER TABLE revenu DROP evenement_id, CHANGE designation designation VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT \'NULL\', CHANGE quantite quantite DOUBLE PRECISION DEFAULT \'NULL\', CHANGE total total INT DEFAULT NULL, CHANGE date_action date_action DATE DEFAULT \'NULL\'');
