 ...
 */
final class Version20200407141849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adhesion CHANGE adherant_id adherant_id INT DEFAULT NULL, CHANGE montant montant VARCHAR(255) DEFAULT NULL, CHANGE dateAdhesion dateAdhesion DATE DEFAULT NULL, CHANGE anneeAdhesion anneeAXdhesion VARCHAR(255) DEFAULT NULL, CHANGE paiement paiement TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adhesion CHANGE adherant_id adherant_id INT DEFAULT NULL, CHANGE montant montant VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE dateAdhesion dateAdhesion DATE DEFAULT \'NULL\', CHANGE annee_adhesion annee_adhesion VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE paiement paiement TINYINT(1) DEFAULT \'NULL\'');
