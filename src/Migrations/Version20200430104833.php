 ...
 */
final class Version20200430104833 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adhesion ADD id INT AUTO_INCREMENT NOT NULL, ADD dateAdhesion DATE DEFAULT NULL, ADD anneeadhesion DATE DEFAULT NULL, DROP dateAdhesion, DROP anneeAdhesion, CHANGE montant montant DOUBLE PRECISION DEFAULT NULL, CHANGE paiement paiement TINYINT(1) DEFAULT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adhesion ADD dateAdhesion DATE DEFAULT \'NULL\', ADD anneeAdhesion DATE DEFAULT \'NULL\', DROP id, DROP anneeAdhesion, DROP anneeAdhesion, CHANGE montant montant DOUBLE PRECISION DEFAULT \'NULL\', CHANGE paiement paiement TINYINT(1) DEFAULT \'NULL\'');
