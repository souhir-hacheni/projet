 ...
 */
final class Version20200503121124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depences CHANGE designation designation VARCHAR(255) DEFAULT NULL, CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT NULL, CHANGE quantite quantite DOUBLE PRECISION DEFAULT NULL, CHANGE total total INT DEFAULT NULL, CHANGE date_action date_action DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE revenu CHANGE evenement_id evenement_id INT DEFAULT NULL, CHANGE designation designation VARCHAR(255) DEFAULT NULL, CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT NULL, CHANGE quantite quantite DOUBLE PRECISION DEFAULT NULL, CHANGE total total INT DEFAULT NULL, CHANGE date_action date_action DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depences CHANGE designation designation VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT \'NULL\', CHANGE quantite quantite DOUBLE PRECISION DEFAULT \'NULL\', CHANGE total total INT DEFAULT NULL, CHANGE date_action date_action DATE DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE revenu CHANGE evenement_id evenement_id INT DEFAULT NULL, CHANGE designation designation VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT \'NULL\', CHANGE quantite quantite DOUBLE PRECISION DEFAULT \'NULL\', CHANGE total total INT DEFAULT NULL, CHANGE date_action date_action DATE DEFAULT \'NULL\'');
